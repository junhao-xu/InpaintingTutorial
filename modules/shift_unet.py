...
# For original Shift_net
from .shift_net.InnerShiftTriple import InnerShiftTriple
...
class UnetSkipConnectionShiftBlock(nn.Module):
    def __init__(self, outer_nc, inner_nc, opt, innerCos_list, shift_list, mask_global, input_nc, \
        ...
        innerCos = InnerCos(strength=opt.strength, skip=0, layer_to_last=layer_to_last, device=device)
