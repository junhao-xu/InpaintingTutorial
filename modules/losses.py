...
class Discounted_L1(nn.Module):
    def __init__(self, opt):
        ...
        self.register_buffer('discounting_mask', torch.tensor(spatial_discounting_mask(opt.fineSize//2 - self.overlap * 2, opt.fineSize//2 - self.overlap * 2, 0.9, opt.discounting)))
        self.L1 = nn.L1Loss()
